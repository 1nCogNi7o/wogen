...
class WoGen(Validator):
    ...
    def banner(self):
        ...
        print(Color.red + '- 1nCogNi7o'.center(width+30) + Color.reset )
    ...
    def data(self):
        ...
        print("Just press enter if you don't know\n")
        ...
        date_engaged_dd = date_engaged[2:4]
        date_engaged_yyyy = date_engaged[4:]
    ...
    def create(self, min_char, max_char, data, num_to_combine):
        ...
        with open('Wordlist.txt', 'w+') as wordlist:
            for num in range(num_to_combine):
    ...
    def main(self):
        ...
        num_to_combine = self.num_to_combine()
        ...
        while True:
            ...
            if generate == 'Y': 
                ...
                self.create(min_char, max_char, data, num_to_combine)
